...
<body>
    %for o in objects :
                ...
                <td width="80%">
                    ...
                    <table class="basic_table" style="border-bottom:1px solid #002966;">
                        <tr>
                            ...
                            <td width="12%" class="cliente"><b>${o.origin or ''|entity}</b></td>
                            <td width="9%" class="cliente"><b>Ref.:</b></td>
                            <td width="12%" class="cliente"><b>${o.link_saleorder.client_order_ref or ''|entity}</b></td>
                        </tr>
                    </table>
                </td>
                <td width="1%"></td>
        ...
        <table class="basic_table" style="color:#121212">
            ...
            %for line in o.invoice_line:
                ...
                <tr>
                  ...
                  %endif
                  %if len(o.link_stockpickingout.move_lines) > 0:
                    %for pedi in o.link_stockpickingout.move_lines:
                      %if (line.product_id == pedi.product_id):
                        ${pedi.tracking_id and pedi.tracking_id.name or '' }
                        ${pedi.tracking_id and pedi.tracking_id.serial or '' }
        ...
        <table class="basic_table">
            <tr>
                <td class="tax_td">
                  <span class="importe">  ${_("IMPORTE CON LETRA:")} </span>
                </td>
            </tr>
            <tr>
                <td class="center_td">
        ...
        <div>
           %if len(o.link_stockpickingout.move_lines) > 0:
             Orden de Salida: ${o.link_stockpickingout.name} <br/>
           %endif
        </div>
